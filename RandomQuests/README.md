...
* Weapons - Настройка для указания оружия для выполнения условия.
	* Enable - Включение и отключение.
	* Ids - Список оружия для выполнения квеста.
	* StartedItem - Выдавать оружие при старте квеста. (Внимание система таркова выдает лишь разобранную базу оружия а не всю сборку.)
		По **StartedItem** - будет принято решение как обыграть выдачу либо собранного оружия, либо аналогию.
