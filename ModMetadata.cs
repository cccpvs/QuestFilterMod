...
public class MyModMetadata : IModMetadata, IModBlazorMetadata
{
    ...
    public Version Version { get; init; } = new Version("1.0.6");
    public Range SptVersion { get; init; } = new Range("~4.1.5");
    ...
    public string HomePage { get; init; } = "/questfiltermod";
    public string HomePageDescription { get; init; } = "Configure QuestFilterMod";
}